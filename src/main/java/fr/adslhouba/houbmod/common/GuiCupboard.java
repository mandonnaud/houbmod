...
{
   private static final ResourceLocation textures = new ResourceLocation(HoubMod.MODID, "textures/gui/container/cupboard.png");
   private TileEntityEnclumeCPO tileTuto;
   private IInventory playerInv;
   
   public GuiCupboard(TileEntityEnclumeCPO tile, InventoryPlayer inventory)
   {
